...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7524)), "E:\\Documents\\web dev\\build-portfolio\\to-do-list\\to-do-list\\app\\page.js"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2756)), "E:\\Documents\\web dev\\build-portfolio\\to-do-list\\to-do-list\\app\\layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["E:\\Documents\\web dev\\build-portfolio\\to-do-list\\to-do-list\\app\\page.js"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3007))
...
var dist = __webpack_require__(6853);
...
function Home() {
    ...
    const [newItem, setNewItem] = (0,react_.useState)({
        name: "",
        price: ""
    });
    const [total, setTotal] = (0,react_.useState)(0);
    //add item to database
    const addItem = async (e)=>{
        e.preventDefault();
        if (newItem.name !== "" && newItem.price !== "") {
            // setItems([...items, newItem]);
            await (0,dist/* addDoc */.ET)((0,dist/* collection */.hJ)(db, "items"), {
    ...
    (0,react_.useEffect)(()=>{
        const q = (0,dist/* query */.IO)((0,dist/* collection */.hJ)(db, "items"));
        const unsubscribe = (0,dist/* onSnapshot */.cf)(q, (QuerySnapshot)=>{
            let itemsArr = [];
    ...
    const deleteItem = async (id)=>{
        await (0,dist/* deleteDoc */.oe)((0,dist/* doc */.JU)(db, "items", id));
    };
                ...
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("form", {
                            className: "gird grid-cols-6 items-center text-black",
                            children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("ul", {
                            children: items.map((item, id)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("li", {
                        ...
                        items.length < 1 ? "" : /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\Documents\web dev\build-portfolio\to-do-list\to-do-list\app\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [405,403], () => (__webpack_exec__(4470)));
